...
- `FromValues`、`FromFile`、`FromEnvironment`、`FromFlags` 创建项目 Source。
...
本包不原地修改配置，不持有 Koanf 或 fsnotify 对象。具体加载见 [`internal/config/koanfadapter`](../../internal/config/koanfadapter/README.md)，监听见 [`internal/config/watcher`](../../internal/config/watcher/README.md)。
